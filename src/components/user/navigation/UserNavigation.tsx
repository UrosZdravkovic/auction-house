...
export const UserNavigation = () => {
  ...
  return (
    <>
      {/* Mobile Navigation - visible below 1050px */}
      <div className="xl-custom:hidden">
        <UserNavigationMobile />
      </div>

      {/* Desktop Navigation - visible at 1050px and above */}
      <header className="hidden xl-custom:block sticky top-5 z-50 mx-4 sm:mx-6">
